...
for j=1:length(f_vec) % loop over each frequency to be tested
    ...
    s_gen = serial('COM7','BaudRate',115200); 
    ...
    s_read = serial('COM12','BaudRate',115200);
...
save('MAE170_lab4Q4','f_vec','transfer_vec'); 
% save frequency and gain to mat file
csvwrite('MAE170_lab4Q4.csv',[f_vec',transfer_vec]);
% save frequency and gain to csv file
saveas(gcf,'MAE170_lab4Q4');
% save figure
